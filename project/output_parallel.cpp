...
int main(int argc, char **argv){
  ...
  #pragma omp parallel shared(p, inputAF, impulseAF, output_buffer, num_input_samples, num_impulse_samples, num_output_samples, num_input_channels, num_impulse_channels, num_output_channels) private(input_channel, impulse_channel, output_channel, input_sample, i, j)
  {
